  ...
  useEffect(() => {
    ...
    var I18N = {
      en: {
        ...
        'hero.sub': "A booking website and a dashboard to run it. We build it and keep it running. You just show up.",
        ...
        'pricing.label': "Pricing", 'pricing.title': "Pick your plan.",
      ...
      he: {
        ...
        'hero.sub': "אתר הזמנות ולוח בקרה שמנהל אותו. אנחנו בונים אותו ושומרים שהוא רץ. אתה פשוט מגיע.",
        ...
        'pricing.label': "מחיר", 'pricing.title': "בחר את התוכנית שלך.",
