...
// ARCHIVED — the header/footer the old book.bapita.com homepage was written
// against, kept alongside it at /legacy. The live marketing chrome is now
// src/components/marketing/{nav,footer}.tsx.
//
