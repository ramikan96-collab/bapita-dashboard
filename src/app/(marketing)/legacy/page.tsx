...
// Archived 2026-08-22 (Batch 3b). This is the book.bapita.com homepage exactly
// as it shipped, kept reachable at /legacy as a backup while the rebuilt
// bapita.com homepage settles. It is noindex and absent from the sitemap, and
// its content is the source the new page's copy was ported from — delete it
// only once nobody needs to diff against it.
const SITE_URL = "https://bapita.com/legacy";
