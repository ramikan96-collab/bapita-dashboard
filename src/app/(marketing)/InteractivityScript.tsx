  ...
  useEffect(() => {
    ...
    var I18N = {
      en: {
        ...
        'test.shimi.n': "Shimi Azout", 'test.shimi.m': "Shimi Azut Hair Studio, Herzliya",
        'test.shimi.p1': "on Google", 'test.shimi.p2': "reviews", 'test.shimi.p3': "on ChatGPT for “best hair salon in Herzliya”",
      ...
      he: {
        ...
        'test.shimi.p1': "בגוגל", 'test.shimi.p2': "ביקורות", 'test.shimi.p3': "הראשון שChatGPT מציג למספרה הטובה בהרצליה",
