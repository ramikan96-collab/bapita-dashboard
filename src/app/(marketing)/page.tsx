...
(function () {
  ...
  var I18N = {
    en: {
      ...
      'test.1.q': "Clients book themselves now. I check the dashboard with my morning coffee and I already know how the day looks. I stopped answering WhatsApp at midnight.", 'test.1.m': "Barbershop · Herzliya",
      'test.2.q': "Three no shows a week used to be normal. The reminders basically ended it. The chair stays full and I am not chasing anyone.", 'test.2.m': "Nail Studio · Ramat Gan",
      'test.3.q': "Someone searched for a barber near me and found me for the first time. They booked that night while I was closed. That never happened before.", 'test.3.m': "Men's Grooming · Tel Aviv",
      'test.4.q': "We had three staff and none of us had time to manage bookings. Now the phone barely rings. Clients find us, pick their treatment, and we just show up ready.", 'test.4.m': "Day Spa · Ra'anana",
      'test.5.q': "No-shows were killing me. The deposit system and reminders ended that overnight. I wish I had done this two years ago.", 'test.5.m': "Lash Studio · Petah Tikva",
      'test.6.q': "I train people all day and had zero time for admin. Bapita sorted my schedule, reminders, and payments. I just focus on coaching now.", 'test.6.m': "Personal Trainer · Ramat Hasharon",
      'test.7.q': "Patients were missing appointments and I had no follow-up system. Now confirmations and reminders run automatically. My front desk does half the work it used to.", 'test.7.m': "Physiotherapy · Haifa",
      'test.8.q': "I had been putting off a website for three years. Bapita built it in 48 hours and it looked better than anything I would have made myself.", 'test.8.m': "Hair Salon · Rishon LeZion",
      'test.9.q': "Deposits were always awkward to ask for. Now it is just part of booking. No more ghost appointments. Clients who put money down always show up.", 'test.9.m': "Tattoo Studio · Tel Aviv",
      'test.10.q': "I work from home and felt too small for a real booking system. Bapita made me feel legitimate. My schedule is finally predictable.", 'test.10.m': "Massage Therapy · Netanya",
      'test.11.q': "My studio went from word-of-mouth to being found on Google every week. The booking page is beautiful and clients tell me it feels professional.", 'test.11.m': "Pilates Studio · Jerusalem",
      'test.12.q': "Admin was eating my evenings. Now I get a notification when someone books, everything is confirmed, and I have zero messages to deal with at night.", 'test.12.m': "Sports Coaching · Beer Sheva",
    ...
    he: {
      ...
      'test.1.q': "הלקוחות קובעים לבד. הפסקתי לענות לוואטסאפ בחצות.", 'test.1.m': "מספרה · הרצליה",
      'test.2.q': "שלושה ביטולים בשבוע היו נורמה. התזכורות סגרו את זה.", 'test.2.m': "סטודיו לציפורניים · רמת גן",
      'test.3.q': "מישהו מצא אותי בגוגל כשהייתי סגור וקבע תור. זה אף פעם לא קרה קודם.", 'test.3.m': "עיצוב גברים · תל אביב",
      'test.4.q': "הטלפון כמעט לא מצלצל. לקוחות מוצאים אותנו ומגיעים.", 'test.4.m': "ספא · רעננה",
      'test.5.q': "מערכת המקדמות סיימה את הביטולים בן לילה. הלוואי שהייתי עושה את זה קודם.", 'test.5.m': "סטודיו לריסים · פתח תקווה",
      'test.6.q': "בפיתה סידר לי לוז ותזכורות. אני פשוט מתמקד באימונים.", 'test.6.m': "מאמן כושר אישי · רמת השרון",
      'test.7.q': "אישורים ותזכורות רצים לבד. הפרונט-דסק עושה חצי מהעבודה.", 'test.7.m': "פיזיותרפיה · חיפה",
      'test.8.q': "בפיתה בנה לי אתר תוך 48 שעות. יצא טוב יותר מכל מה שהייתי בונה לבד.", 'test.8.m': "מספרה לנשים · ראשון לציון",
      'test.9.q': "לבקש מקדמות תמיד היה מביך. עכשיו זה פשוט חלק מהקביעה.", 'test.9.m': "סטודיו לקעקועים · תל אביב",
      'test.10.q': "הרגשתי קטנה מדי למערכת אמיתית. בפיתה גרם לי להרגיש מקצועית.", 'test.10.m': "מטפלת בעיסוי · נתניה",
      'test.11.q': "הסטודיו עבר מהמלצות לכך שמוצאים אותי בגוגל כל שבוע.", 'test.11.m': "סטודיו לפילאטיס · ירושלים",
      'test.12.q': "האדמין אכל לי את הערבים. עכשיו אני רק מקבל התראה כשמישהו קובע.", 'test.12.m': "אימוני ספורט · באר שבע",
