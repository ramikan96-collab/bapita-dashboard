...
export function ShimiAzutHairstudioPage({ business, services }: Props) {
  ...
  const accent       = business.accent_color || BRAND_ACCENT;
  ...
  const headingFont  = resolveFont(business.heading_font, "'Secular One', sans-serif");
  const bodyFont     = resolveFont(business.body_font,    "'Rubik', sans-serif");
