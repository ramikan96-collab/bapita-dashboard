    ...
    <div className={playfairDisplay.className} dir={isRtl ? "rtl" : "ltr"} style={{ background: C.bg, minHeight: "100svh", fontFamily: bodyFont, color: C.dark }}>
      ...
      <section style={{ position: "relative", height: "100svh", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
          <SmartImg src={heroImage} maxWidth={1920} widths={[640, 828, 1200, 1920, 2048]} sizes="100vw" quality={90} loading="eager" fetchPriority="high" alt="" className="c-hero-img" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: heroFocal, transformOrigin: "center center" }} />
        </div>
                ...
                <section key={key} style={{ paddingTop: 56 }}>
                  ...
                  <div style={{ marginTop: 28 }}>
                    {showInstaGallery
                      ...
                      : (groupedView
                        ? <SectionGalleryGrouped groups={photoGroups} initialCount={4} desktopInitialCount={4} focal={business.image_focal ?? undefined} altLabel={displayName} headingColor={C.dark} mutedColor="rgba(34,21,16,0.55)" headingFont={headingFont} />
