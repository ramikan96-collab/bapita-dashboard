  ...
  return (
    <div className={plusJakartaSans.className} dir={isRtl ? "rtl" : "ltr"} style={{ background: P.bg, minHeight: "100svh", fontFamily: bodyFont, color: P.text }}>
      ...
      {cta.mode === "native" && overlayOpen && (stayMode
          ...
          ? (services.length > 0 ? (
              <StayOverlay business={business} units={services} unit={selectedService ?? null} onClose={closeOverlay} accentColor={accent} darkColor={P.text} bgColor={P.bg} lang={lang} />
            ) : null)
