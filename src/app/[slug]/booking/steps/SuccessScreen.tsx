...
export function SuccessScreen({ service, date, time, customerName, businessName, businessPhone, businessAddress, accentColor, darkColor, bgColor }: Props) {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:20, paddingTop:24, paddingBottom:16 }}>
      ...
      <div style={{ textAlign:"center" }}>
        <div style={{ fontSize:24, fontWeight:900, color:darkColor, marginBottom:8 }}>Booking confirmed!</div>
        <div style={{ fontSize:15, color:darkColor, opacity:0.6 }}>See you soon, {customerName}.</div>
      </div>
