export const he = {
  ...
  reviews: { title: "מה הלקוחות אומרים", titleGuests: "מה האורחים אומרים", leaveReviewHintGuests: "התארחת אצלנו? זה לוקח שתי דקות ועוזר לאורח הבא לבחור.", leaveReview: "להשאיר ביקורת בגוגל", showMore: "הצג עוד", showLess: "הצג פחות" },
  staff: { title: "הצוות" },
  ...
  stay: {
    ...
    moreAmenities: (n: number) => `+${n} נוספים`,
    viewPlace: "לפרטים על המקום",
    checkIn: "צ׳ק אין",
    checkOut: "צ׳ק אאוט",
  ...
  page: {
    back: (name: string) => `→ חזרה ל${name}`,
    details: "פרטים",
    more: "עוד",
    gallery: "תמונות",
    minStay: "שהייה מינימלית",
  },
};
